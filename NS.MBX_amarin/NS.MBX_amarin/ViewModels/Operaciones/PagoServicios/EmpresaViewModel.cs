...
namespace NS.MBX_amarin.ViewModels
{
	public class EmpresaViewModel : ViewModelBase
	{
        ...
        async void ExecuteItemTappedIC()
        {
            Catalogo empresa = new Catalogo
            {
                IdTabla = ItemSeleccionado.IdTabla,
        ...
        private DelegateCommand _buscadorUnfocusedIC;
        public DelegateCommand BuscadorUnfocusedIC =>
            _buscadorUnfocusedIC ?? (_buscadorUnfocusedIC = new DelegateCommand(ExecuteBuscadorUnfocusedIC));

        void ExecuteBuscadorUnfocusedIC()
        {
            MostrarBuscador = false;
        }
    }
