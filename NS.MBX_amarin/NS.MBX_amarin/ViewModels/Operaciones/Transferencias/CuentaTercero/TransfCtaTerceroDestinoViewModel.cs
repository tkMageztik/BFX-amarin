        ...
        public override void OnNavigatingTo(NavigationParameters parameters)
        {
            try
            {
                ...
                if (pageOrigen == Constantes.pageOperaciones)
                {
                    ...
                    NumCtaDestino = opeFrec.CtaDestino.CodigoCta;
                    MonedaSel = ListaMonedas.Where(p => p.Codigo == opeFrec.Moneda.Codigo).First();
                    TipoCtaSel = ListaTiposCta.Where(p => p.Descripcion == opeFrec.CtaDestino.idMoneda).First();
                }

                Cuenta ctaOrigen = parameters[Constantes.keyCtaCargo] as Cuenta;
