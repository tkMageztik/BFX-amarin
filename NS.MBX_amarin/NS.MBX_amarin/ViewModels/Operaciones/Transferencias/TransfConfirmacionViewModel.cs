...
namespace NS.MBX_amarin.ViewModels
{
    public class TransfConfirmacionViewModel : ViewModelBase
    {
        ...
        public override void OnNavigatingTo(NavigationParameters parametros)
        {
            ...
            else if (pageOrigen == Constantes.pageTransfCtaOtroBancoDestino)
            {
                LblNombreCta2 = ctaDestino.NombreTitular;
                LblCodCta2 = ctaDestino.CodigoCta;
                LblTipoOpe = "Transferencia";
        ...
        public async Task AccionCtaPropia()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    //{
                    //    string retroceso = "../../../../../";
                    //    await NavigationService.NavigateAsync(retroceso + Constantes.pageTransfResumen, parametros);
                    //}
                    //catch(Exception ex)
                    //{
                    //    await NavigationService.NavigateAsync(Constantes.pageOperaciones + "/" + Constantes.pageTransfResumen, parametros);
                    //}
                    ...
                    await NavigationService.NavigateAsync(retroceso + Constantes.pageTransfResumen, parametros); //de esta forma cuando vaya hacia atras volvera al home
                }
        ...
        public void RegistrarOperacionFrecuente(DateTime fechaOperacion)
        {
            if (IsOperacionFrecuente)
            {
                ...
                else if (operacion.Id == "3" && (suboperacion.Id == "0" || suboperacion.Id == "1")) //otra cta financiero
                {
                    opeFrec.CtaOrigen = ctaOrigen;
                    opeFrec.CtaDestino = ctaDestino;
                    opeFrec.Moneda = moneda;
